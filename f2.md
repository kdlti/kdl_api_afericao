...
Para recuperar informações consolidadas das peças comissionadas para este indicador agrupadas por subprefeituras é necessário definir como parte da URI o mês e ano, incluíndo o parâmetro `subPrefeitura=LAPA`.
