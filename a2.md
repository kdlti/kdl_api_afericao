...
| Método | URI | Exemplo                                                    | 
| --- | --- | :-----------                                               | 
| GET | `/a2/00/0000` | api-afericao.kdltelegestao.com.br/a2/04/2022 |
...
| --- | --- | ----------| :----------- | 
| GET | `/a2/00/0000` | ?subPrefeitura=LAPA | api-afericao.kdltelegestao.com.br/a2/04/2022?subPrefeitura=LAPA |
...
| Método | URI |  Exemplo      | 
| --- | --- |  :----------- | 
| GET | `/a2/00/0000/IP00000A` | api-afericao.kdltelegestao.com.br/a2/04/2022/IP00000A | 
...
| Método | URI |  Exemplo      | 
| --- | --- |  :----------- | 
| POST | `/a2/00/0000` | api-afericao.kdltelegestao.com.br/a2/04/2022 | 
...
| Indentificador | Tipo     | Descrição | 
| :-------------- | ---------| :------------------------------------------          | 
| 0~23           | `int` | Quantidade de minutos desligado durante a noite         |
